...
def move_tiles(window, tiles, clock, direction):
    ...
    if direction == "left":
        ...
        def move_check(
            tile, next_tile): return tile.x > next_tile.x + RECT_WIDTH + MOVE_VEL
        ceil = True
        ...
        def merge_check(
            tile, next_tile): return tile.x < next_tile.x - MOVE_VEL
        def move_check(
            tile, next_tile): return tile.x + RECT_WIDTH + MOVE_VEL < next_tile.x
        ceil = False
        ...
        def move_check(
            tile, next_tile): return tile.y > next_tile.y + RECT_HEIGHT + MOVE_VEL
        ceil = True
        ...
        def merge_check(
            tile, next_tile): return tile.y < next_tile.y - MOVE_VEL
        def move_check(
            tile, next_tile): return tile.y + RECT_HEIGHT + MOVE_VEL < next_tile.y
        ceil = False
